  ...
  return (
    <div className="flex flex-col h-full rounded-xl overflow-hidden border border-border bg-[#0d1117] font-mono text-sm shadow-inner" data-testid="cypher-editor">
      <div className="bg-secondary/50 px-3 py-2 flex justify-between items-center border-b border-border">
        <span className="text-xs text-muted-foreground uppercase tracking-wider font-semibold">Cypher Query</span>
        <Button size="sm" className="h-7 text-xs px-2.5 bg-primary text-primary-foreground hover:bg-primary/90">
